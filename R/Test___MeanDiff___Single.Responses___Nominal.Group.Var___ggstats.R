Test___MeanDiff___Single.Responses___Nominal.Group.Var___ggstats = function(Data,
  ...
  plot_with_results = Test___MeanDiff___Single.Responses___Nominal.Group.Var___ggstats___plotting(Data,
                                                                                                   Response_Var,
                                                                                                   Group_Var,
                                                                                                   alpha_ANOVA,
                                                                                                   # Tests results
  ...
  # 🟥 plotting with results =============================================================================
  plot_without_results = Test___MeanDiff___Single.Responses___Nominal.Group.Var___ggstats___plotting(Data,
                                                                                                     Response_Var,
                                                                                                     Group_Var,
                                                                                                     alpha_ANOVA,
                                                                                                     # Tests results
