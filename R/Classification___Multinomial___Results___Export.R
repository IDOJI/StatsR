Classification___Multinomial___Results___Export = function(Combined.list, path_Export){
  ...
  Best_hyperparameters = data.frame(best_lambda = Combined.list$Best_Fit$lambdaVals, best_alpha = Combined.list$Best_alpha)
  write.csv(Best_hyperparameters, paste0(path_Export, "/", "1.Best_hyperparameters.csv"))
  ...
  write.csv(Misclassified_Subjects, paste0(path_Export, "/", "2.Misclassified_Subjects.csv"))
  ...
  write.csv(Coefficients, paste0(path_Export, "/", "3.Coefficients.csv"))
  ...
  write.csv(Confusion.mat, paste0(path_Export, "/", "4.Confusion.mat.csv"))
  ...
  write.csv(Misclassification_Rate, paste0(path_Export, "/", "5.Misclassification_Rate.csv"))
